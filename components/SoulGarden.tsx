...
import { ArrowRight, ArrowLeft, Sprout, CloudRain, Sun, Droplets } from 'lucide-react';
  ...
  return (
    <div className="h-full bg-transparent flex flex-col pt-safe pb-safe animate-fadeIn overflow-hidden relative">
      ...
      <main className="flex-1 flex flex-col items-center justify-center relative z-10 pb-12">
          <div className="text-center mb-8 bg-white/30 backdrop-blur-md p-6 rounded-3xl border border-white/40 mx-6 shadow-lg">
          ...
          <button 
             onClick={handleWater}
             disabled={isWatering}
             className="mt-12 bg-gradient-to-r from-blue-500 to-teal-500 text-white px-8 py-4 rounded-full shadow-lg shadow-blue-500/30 flex items-center gap-3 transition-all active:scale-95 hover:scale-105 border border-white/20 relative overflow-hidden"
          >
